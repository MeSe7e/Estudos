...
def load_data_jogos():
    data_jogos = pd.read_csv("https://github.com/futpythontrader/YouTube/blob/main/Jogos_do_Dia/FlashScore/Jogos_do_Dia_FlashScore_"+ str(dia) +".csv?raw=true") # ?raw=true, porque é um arquivo que está no github
    return data_jogos
